   ...
   try {
    ...
    //   }
      if (e.type == DioErrorType.connectTimeout) {
        return AllRoomResponse(erMsg: 'No internet Connection',isFailed: true);
      }
      if (e.type == DioErrorType.response) {
        return AllRoomResponse(erMsg: "Service not available",isFailed: true);
      }
      if (e.type == DioErrorType.other) {
        return AllRoomResponse(erMsg: 'Something went wrong',isFailed: true);
      }
      if (e is SocketException) {
        return AllRoomResponse(erMsg: "Bad Internet Connection",isFailed: true);
      }
